...
configurationMetadata = cms.untracked.PSet(
	...
	name = cms.untracked.string('\$Source: /afs/cern.ch/project/cvs/reps/CMSSW/CMSSW/Configuration/GenProduction/python/RSGravitonToZZ_kMpl01_M_1000_Tune23_7TeV_herwiggpp_cff.py,v $'),
