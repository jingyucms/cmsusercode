...
if __name__=="__main__":
	...
	new_hists+=[h1sysstat]
	  ...
	  for b in range(h5.GetNbinsX()):
        ...
        h0.GetYaxis().SetRangeUser(0,0.35)
        ...
        ylabel=offsets[massbin]*2.2+0.42
        
        if massbin==0: title="3.6 < #font[72]{M_{jj}} < 4.2"
        if massbin==1: title="#font[72]{M_{jj}} > 4.2"
    ...
    c.SaveAs(prefix + "_combined_theory.pdf")
    c.SaveAs(prefix + "_combined_theory.eps")
