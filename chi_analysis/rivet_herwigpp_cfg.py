...
# with command line options: Configuration/GenProduction/python/QCD_Pt_15to3000_Tune23_Flat_7TeV_herwigpp_cff.py -s GEN --datatier=GEN-SIM-RAW --conditions auto:mc --eventcontent RAWSIM --no_exec -n 10000 --python_filename=rivet_herwigpp_cfg.py --customise=Configuration/GenProduction/rivet_customize.py
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('\\$Source: /cvs/CMSSW/CMSSW/Configuration/GenProduction/python/Attic/QCD_Pt_15to3000_Tune23_Flat_7TeV_herwigpp_cff.py,v $')
)
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('QCD_Pt_15to3000_Tune23_Flat_7TeV_herwigpp_cff_py_GEN.root'),
...
process.generator = cms.EDFilter("ThePEGGeneratorFilter",
    ...
    crossSection = cms.untracked.double(23095400000.0),
    parameterSets = cms.vstring('cm7TeV', 
        'pdfMRST2001', 
        'productionParameters', 
        'basicSetup', 
        'setParticlesStableForDetector'),
    productionParameters = cms.vstring('mkdir /Herwig/Weights', 
        'cd /Herwig/Weights', 
...
process.rivetAnalyzer.OutputFile = cms.string('herwigpp.aida')
