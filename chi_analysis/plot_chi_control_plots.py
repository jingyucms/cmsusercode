...
if __name__ == '__main__':
   ...
   for postfix in ["","_chi1","_chi6","_chi11"]:
     ...
     if postfix=="_chi1":
       legend=TLegend(0.45,0.7,0.95,0.90,"1<#Chi<6 , y_{boost}<1.11")
     elif postfix=="_chi6":
       legend=TLegend(0.45,0.7,0.95,0.90,"6<#Chi<11 , y_{boost}<1.11")
     elif postfix=="_chi11":
       legend=TLegend(0.45,0.7,0.95,0.90,"11<#Chi<16 , y_{boost}<1.11")
     else:
       legend=TLegend(0.45,0.7,0.95,0.90,"#Chi<16 , y_{boost}<1.11")

     hist=f_data[0].Get("dijet_mass"+postfix)
     for i in range(1,len(data)):
    	 hist.Add(f_data[i].Get("dijet_mass"+postfix))
     hist.SetLineColor(1)
     ...
     hist2=f_data2[0].Get("dijet_mass"+postfix)
     for i in range(1,len(data2)):
    	 hist2.Add(f_data2[i].Get("dijet_mass"+postfix))
     ...
     if not "chi" in postfix:
       hist_mc=f_mc[0].Get("dijet_mass"+postfix)
       for i in range(1,len(mc)):
    	   hist_mc.Add(f_mc[i].Get("dijet_mass"+postfix),mc[i][1]/mc[0][1])
     ...
     hist_mc3=f_mc3[0].Get("dijet_mass"+postfix)
     for i in range(1,len(mc3)):
    	 hist_mc3.Add(f_mc3[i].Get("dijet_mass"+postfix),mc3[i][1]/mc3[0][1])
     ...
     hist_mc2=f_mc2[0].Get("dijet_mass"+postfix)
     for i in range(1,len(mc2)):
    	 hist_mc2.Add(f_mc2[i].Get("dijet_mass"+postfix),mc2[i][1]/mc2[0][1])
     ...
     canvas.SaveAs("chi_control_plots_mass"+postfix+"_"+prefix+".root")
     canvas.SaveAs("chi_control_plots_mass"+postfix+"_"+prefix+".pdf")
