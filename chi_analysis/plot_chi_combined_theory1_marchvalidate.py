 ...
 for set in [1,2,3,4]:
  for massbins in [[(3600,4200)],[(4200,8000)]]:
	...
	new_hists+=[h1sysstat]
        ...
        if massbin>=0:
	  if set==1:
            filename="datacard_shapelimit_DLOCI7000_chi.root"
            histname='QCDDLOCI7000#chi'+str(massbins[massbin]).strip("()").replace(',',"_").replace(' ',"")+"_rebin1"
	  if set==2:
            filename="datacard_shapelimit_CI_1_1_1_10000_chi.root"
            histname='QCDCI_1_1_1_10000#chi'+str(massbins[massbin]).strip("()").replace(',',"_").replace(' ',"")+"_rebin1"
	  if set==3:
            filename="datacard_shapelimit_CI_0_0_1_7000_chi.root"
            histname='QCDCI_0_0_1_7000#chi'+str(massbins[massbin]).strip("()").replace(',',"_").replace(' ',"")+"_rebin1"
	  if set==4:
            filename="datacard_shapelimit_DNLOCI7000_chi.root"
            histname='QCDDNLOCI7000#chi'+str(massbins[massbin]).strip("()").replace(',',"_").replace(' ',"")+"_rebin1"
          print filename
          f = TFile.Open(filename)
          new_hists+=[f]
          print histname
	  ...
	  if set==1:
            filename="datacard_shapelimit_cteq6ll_7000_LL+_chi.root"
            histname='QCDcteq6ll_7000_LL+#chi'+str(massbins[massbin]).strip("()").replace(',',"_").replace(' ',"")+"_rebin1"
	  if set==2:
            filename="datacard_shapelimit_cteq6ll_10000_VV+_chi.root"
            histname='QCDcteq6ll_10000_VV+#chi'+str(massbins[massbin]).strip("()").replace(',',"_").replace(' ',"")+"_rebin1"
	  if set==3:
            filename="datacard_shapelimit_cteq6ll_7000_V-A+_chi.root"
            histname='QCDcteq6ll_7000_V-A+#chi'+str(massbins[massbin]).strip("()").replace(',',"_").replace(' ',"")+"_rebin1"
	  if set==4:
            filename="datacard_shapelimit_cteq66_7000_LL+_chi.root"
            histname='QCDcteq66_7000_LL+#chi'+str(massbins[massbin]).strip("()").replace(',',"_").replace(' ',"")+"_rebin1"
          print filename
          f = TFile.Open(filename)
          new_hists+=[f]
          print histname
	  ...
	  if set==1:
            filename="datacard_shapelimit_LOCI7000_chi.root"
            histname='QCDLOCI7000#chi'+str(massbins[massbin]).strip("()").replace(',',"_").replace(' ',"")+"_rebin1"
	  if set==2:
            filename="datacard_shapelimit_CI_-1_-1_-1_10000_chi.root"
            histname='QCDCI_-1_-1_-1_10000#chi'+str(massbins[massbin]).strip("()").replace(',',"_").replace(' ',"")+"_rebin1"
	  if set==3:
            filename="datacard_shapelimit_CI_0_0_1_7000_chi.root"
            histname='QCDCI_0_0_1_7000#chi'+str(massbins[massbin]).strip("()").replace(',',"_").replace(' ',"")+"_rebin1"
	  if set==4:
            filename="datacard_shapelimit_NLOCI7000_chi.root"
            histname='QCDNLOCI7000#chi'+str(massbins[massbin]).strip("()").replace(',',"_").replace(' ',"")+"_rebin1"
          print filename
          f = TFile.Open(filename)
          new_hists+=[f]
          print histname
    ...
    if set==1:
      l2.AddEntry(h4,"#Lambda_{LL}^{#font[122]{+}} (LO) = 7 TeV","l")
      l2.AddEntry(h4b,"#Lambda_{LL}^{#font[122]{+}} (LO) new = 7 TeV","l")
      l2.AddEntry(h4c,"#Lambda_{LL}^{#font[122]{-}} (LO) = 7 TeV","l")
      l2.AddEntry(h4d,"#Lambda_{LL}^{#font[122]{-}} (LO) new = 7 TeV","l")
    if set==2:
      l2.AddEntry(h4,"#Lambda_{VV}^{#font[122]{+}} (LO) = 10 TeV","l")
      l2.AddEntry(h4b,"#Lambda_{VV}^{#font[122]{+}} (LO) new = 10 TeV","l")
      l2.AddEntry(h4c,"#Lambda_{VV}^{#font[122]{-}} (LO) = 10 TeV","l")
      l2.AddEntry(h4d,"#Lambda_{VV}^{#font[122]{-}} (LO) new = 10 TeV","l")
    if set==3:
      l2.AddEntry(h4,"#Lambda_{V-A}^{#font[122]{+}} (LO) = 7 TeV","l")
      l2.AddEntry(h4b,"#Lambda_{V-A}^{#font[122]{+}} (LO) new = 7 TeV","l")
      l2.AddEntry(h4c,"#Lambda_{V-A}^{#font[122]{-}} (LO) = 7 TeV","l")
      l2.AddEntry(h4d,"#Lambda_{V-A}^{#font[122]{-}} (LO) new = 7 TeV","l")
    if set==4:
      l2.AddEntry(h4,"#Lambda_{LL}^{#font[122]{+}} (NLO) = 7 TeV","l")
      l2.AddEntry(h4b,"#Lambda_{LL}^{#font[122]{+}} (NLO) new = 7 TeV","l")
      l2.AddEntry(h4c,"#Lambda_{LL}^{#font[122]{-}} (NLO) = 7 TeV","l")
      l2.AddEntry(h4d,"#Lambda_{LL}^{#font[122]{-}} (NLO) new = 7 TeV","l")
    l2.SetFillStyle(0)
    l2.Draw("same")
    ...
    c.SaveAs(prefix + "_combined_theory"+str(massbins).strip("([])").replace(",","_").replace(" ","")+"_validate"+str(set)+".pdf")
    c.SaveAs(prefix + "_combined_theory"+str(massbins).strip("([])").replace(",","_").replace(" ","")+"_validate"+str(set)+".eps")
