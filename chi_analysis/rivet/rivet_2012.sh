...
cmsRun cmsusercode/chi_analysis/rivet/rivet_pythia6_cfg.py

rivet-mkhtml -c GeneratorInterface/RivetInterface/data/CMS_2012_I1090423.plot pythia6.aida GeneratorInterface/RivetInterface/data/CMS_2012_I1090423.aida
