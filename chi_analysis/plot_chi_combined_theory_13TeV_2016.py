  ...
  for massbin in [4,5,6]:
	...
	new_hists+=[h2new]
	  ...
	  for b in range(h4b.GetNbinsX()):
          ...
          filename="datacard_shapelimit13TeV_cs_ct14nlo_14000_VV+_chi2016.root"
	  ...
	  for b in range(h4d.GetNbinsX()):
          ...
          filename="datacard_shapelimit13TeV_cs_ct14nlo_14000_AA+_chi2016.root"
	  ...
	  for b in range(h4f.GetNbinsX()):
          ...
          filename="datacard_shapelimit13TeV_cs_ct14nlo_14000_V-A+_chi2016.root"
