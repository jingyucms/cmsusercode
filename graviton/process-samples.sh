...
particle=Z
  ...
  dir=RSGravitonTo${particle}${particle}_kMpl_01_M_${scale}_Tune23_7TeV_herwiggpp
...
process.source.fileNames = cms.untracked.vstring(['/store/cmst3/user/mpierini/DiJetFASTSIM/RSGraviton${particle}${particle}/${dir}_cff_py_GEN_FASTSIM_HLT_PU.root'])
